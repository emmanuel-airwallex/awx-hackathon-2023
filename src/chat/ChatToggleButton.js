...
function ChatToggleButton(params) {
    ...
    return <div onClick={onClick} className={"fixed bottom-8 right-8 w-20 h-20 rounded-full bg-gray-50 ring-2 cursor-pointer ring-gray-300 shadow-lg transition-all hover:ring-blue-400 hover:ring-4 hover:-translate-y-2 hover:shadow-xl " + (params.isOpen ? "ring-blue-400 ring-4 -translate-y-2 shadow-xl" : "")} title="Query Airwallex data">
        { params.isOpen ? (
