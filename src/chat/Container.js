...
function Container() {
    return (
        <div className="fixed bottom-0 right-0 m-4 p-8 h-3/4 max-w-lg w-full m-8">
            <div className="bg-gray-50 m-4 p-8 ring-2 rounded ring-gray-100 w-full h-full flex flex-col shadow-lg">
                <div className="flex flex-col">
                    <h1 className="font-bold text-gray-700 mb-4">Airpilot</h1>
                    <hr className="mb-4" />
                    <div className="flex-grow overflow-scroll no-scrollbar">
                        <div className="flex flex-col">
                            <Message fromBot={true} message="From bot" />
                            <Message fromBot={false} message="From human" />
                            <Message fromBot={true} message="From bot" />
                            <Message fromBot={false} message="From human" />
                            <Message fromBot={true} message="From bot" />
                            <Message fromBot={false} message="From human" />
                ...
                <div className="block w-full">
                    <div className="flex flex-row h-10">
                        <input className="flex-grow w-full p-4 ring-2 rounded ring-gray-100" placeholder="What were AUDUSD rates over the past year?" />
