            ...
            <div className="bg-gray-50 m-4 p-8 ring-2 rounded ring-gray-100 w-full h-full flex flex-col shadow-lg">
                ...
                <div className="block w-full">
                    <div className="flex flex-row h-10">
                        <input className="flex-grow w-full p-4 ring-2 rounded ring-gray-100" placeholder="What were AUDUSD rates over the past year?" onKeyDown={onChangeHandler} onChange={onChangeHandler} value={inputValue}/>
